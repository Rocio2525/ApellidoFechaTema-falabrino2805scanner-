...
public class Main {
  ...
  ImageIcon bancon= new ImageIcon("src/imagen/bancon_1.png");
     
        JOptionPane.showMessageDialog(null, "", "bienvenido al banco Córdoba  ", JOptionPane.INFORMATION_MESSAGE, bancon);  
    ...
    public static void datosUsuario(String nombre,String apellido,int dni,int sueldomensual){
            System.out.println("==========BANCO CÓRDOBA ================");
